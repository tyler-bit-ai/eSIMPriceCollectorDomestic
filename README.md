...
- 최근 publish 스냅샷: `run-20260320T012354Z-22f35c62`
- 최근 실행 메타데이터: `success_count=2083`, `failure_count=1`
...
- 대시보드에서 국가별 가격 분포, `local / roaming` 가격 차이, 시점별 변경 상품, 상세 비교표를 확인할 수 있습니다.
...
- `시점별 변경 상품`: 선택한 2개 시점 사이에서 가격 또는 노출 여부가 달라진 상품만 확인
- `상세 비교표`: 대표 옵션, 최저가, 옵션 수, 원본 링크 확인 및 CSV 다운로드
- `비교 시점 선택`: 드롭다운에서 원하는 시점 2개까지 선택 가능
